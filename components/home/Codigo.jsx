  ...
  return (
    <>
      ...
      <ul className="nobullet">
        ...
        <li>
          <a href="https://github.com/pauek/minicc">MiniCC</a>, un intérprete de C++ para usos
          pedagógicos.
        </li>
        <li>
          <a href="https://github.com/pauek/Kwidgin">Kwidgin</a>, generador de preguntas de test
          permutadas.
        </li>
        <li>
          <a href="https://github.com/pauek/SpeakerFeedback">SpeakerFeedback</a>, una <i>app</i>{" "}
          Android para votación de preguntas a un conferenciante, usando Firebase.
        </li>
        <li>
          <a href="https://github.com/pauek/Ejemplos-Android">Ejemplos Android</a>, respositorio con
          aplicaciones Android de ejemplo.
        </li>
        <li>
          <a href="https://github.com/pauek/garzon">Garzón</a>, un juez para problemas de
          programación.
        </li>
        <li>
          <a href="https://github.com/pauek/CodeBoard">CodeBoard</a>, una pizarra de código fuente
          en tiempo real.
        </li>
        <li>
