export const Presentacion = () => {
  return (
    <>
      <p>
        <span className="role">Co-director</span> del{" "}
        <a href="https://bit.ly/2Nc8NRv">Posgrado en Full-Stack Web Technologies</a>, en{" "}
        <a href="https://talent.upc.edu">UPC School</a>.
      </p>
      <p>
